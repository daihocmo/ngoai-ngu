...
Đây là một thẻ rất đơn giản và còn có [những loại khác](https://www.antimoon.com/how/usingsm-makeitems.htm).
...
2.  Bạn trả lời câu hỏi thông qua việc nghĩ câu trả lời hoặc nói nó ra, chứ không ghi câu trả lời bằng bàn phím.
...
4.  Bạn so sánh câu trả lời của mình với câu trả lời đúng và tự cho [Điểm](https://www.antimoon.com/words/grade-n.htm) - ví dụ:, *kém*, *tốt* or *rất tốt*. [Điểm số](https://www.antimoon.com/words/grade-n.htm) sẽ cho SRS biết bạn nhớ từ đó tốt đến mức nào.
5.  Khi nào bạn nên xem lại mục đó sẽ do SRS thực hiện, chúng được gọi là khoảng lặp lại Từ điểm của bạn, điểm trước đó, và các số liệu thống kê khác, SRS có thể tính toán thời gian bạn sẽ nhớ từ đó. Sau đó nó đặt ngày lặp lại tiếp theo. Ngày được ấn định để đảm bảo khả năng gợi nhớ thành công rất cao ở lần lặp lại tiếp theo.

## Phiên hàng ngày với SRS trông như thế nào?

Quá trình học qua SRS:

1.  **Xem lại các từ mà SRS của bạn đã lên kế hoạch cho ngày hôm nay.** Thông thường, số lượng từ mà bạn ôn tập mỗi ngày là rất ít. Ví dụ: nếu bạn có 8.000 từ tiếng Anh trong SRS, bạn có thể chỉ phải ôn lại 40 từ mỗi ngày.
2.  **Ôn lại các từ khó** (hay còn gọi là công cuộc cày cuốc cuối cùng). Bạn xem lại tất cả các từ mà bạn đạt điểm từ 3 trở xuống. Bạn xem lại từng từ cho đến khi đạt được ít nhất 4 điểm.
3.  **Ghi nhớ từ mới.** Bạn học từ lần đầu tiên. Bạn sẽ xem lại những từ này trong một vài ngày.
4.  **Thêm từ mới.** Bạn có thể sử dụng từ điển để tạo ra các mục của riêng mình bằng một câu hỏi và một câu trả lời.

## Làm cách nào để thêm các mục mới vào SRS của tôi?

Bạn sao chép và đưa các câu ví dụ, từ và [phiên âm](https://www.antimoon.com/how/pronunc-trans.htm) từ [từ điển tiếng Anh](https://www.antimoon.com/how/dict.htm) vào SRS của mình. Thay vì lấy các câu ví dụ từ từ điển, bạn cũng có thể lấy chúng từ sách, phim, trò chơi điện tử, v.v.
