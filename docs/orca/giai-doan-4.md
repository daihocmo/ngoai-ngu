...
Có thể nhiều người sẽ nói với bạn rằng để output được thì bắt buộc phải tập luyện output. Mình xin cam đoan rằng chỉ cần nạp một lượng input đủ lớn thì khả năng output sẽ tự nhiên hình thành (mặc dù ở giai đoạn đầu thì nó sẽ không hoành tráng cho lắm. Hãy chấp nhận rằng khi mới mở miệng nói thì ai cũng mắc nhiều lỗi sai).

### Dành riêng cho tiếng Nhật
